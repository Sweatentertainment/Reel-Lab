/* The deck engine. Content-agnostic: each deck's page imports its own slide
   set and calls mount(SLIDES), so the proposal and the two case-study decks
   all run on this one file. */
