...
| **Bespoke** — St Lundi | `stlundi-proposal.html` | `slides-stlundi.js` | `Sweat-St-Lundi-Proposal.pdf` (25pp) |
...
| **Partner** — Clouted × Sweat, paid media | `clouted-proposal.html` | `slides-clouted.js` | `Sweat-Clouted-Paid-Media.pdf` (22pp) |
