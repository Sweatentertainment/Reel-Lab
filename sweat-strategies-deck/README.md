...
| **Investor** — DAVID, document cut | `david-proposal.html` | `slides-david.js` | `DAVID-Seed-Deck.pdf` (14pp) |
| **Investor** — DAVID, pitch cut | `david-pitch.html` | `slides-david-pitch.js` | `DAVID-Pitch-Deck.pdf` (12pp) |
