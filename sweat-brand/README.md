...
| `DAVID-Seed-Deck.pdf` | 17 | **Investor** — DAVID seed round, the document cut. Emailed and read alone |
| `DAVID-Pitch-Deck.pdf` | 15 | **Investor** — DAVID seed round, the pitch cut. 757 words, diagram-led, for presenting |
